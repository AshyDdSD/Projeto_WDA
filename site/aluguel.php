...
<body>
        ...
        <div class="container-fluid">
            ...
            <div id="bar">
                <ul id="barrinha">
                    ...
                    <li class="pedaco">
                        <a class="clica" aria-current="page" href="#">Aluguel</a>
                    </li>
                    <li class="pedaco">
    ...
    <div class="container-fluid" id="tabela">
        <h4 class="assunto">Aluguel</h4>
        <table id="tsup">
            <tr>
                <td><a class="btn btn-primary" style="border-radius: 30px;" href="../cad/cad_alug.php" role="button">Novo +</a></td>
                <td></td>
                <td></td>
                <td>      
                    <form  action="">
        ...
        <table id="tinf" class="table table-borderless">
            ...
            <tbody>
                <tr><?php include_once '../pesquisa/pesquisa_alug.php' ?></tr>
            </tbody>
        </table>
    </div>
